...
func TestSourceChunksResumption(t *testing.T) {
	...
	assert.Equal(t, 12, int(finalProgress.SectionsCompleted), "Should have completed sections")
	assert.Equal(t, 12, int(finalProgress.SectionsRemaining), "Should have remaining sections")
}
